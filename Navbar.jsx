...
//                   <Link className="nav-link text-light" aria-current="page" to="/" onClick={() => this.props.changeSearch('')}>All</Link>
//                 </li>
//                 <li className="nav-item">
...
//                 </li>
//                 <li className="nav-item">
//                   <Link className="nav-link text-light test-light" to="/Entertainment" onClick={() => this.props.changeSearch('')}>Entertainment</Link>
//                 </li>
...
//                 <input className="form-control me-2" type="search" name='search' onChange={(e) => this.getInputData(e)} placeholder="Search" aria-label="Search" />
